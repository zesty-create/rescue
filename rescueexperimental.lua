...
local function getRandomSkyPosition()
    return Vector3.new(math.random(-100000, 100000), math.random(20000, 40000), math.random(-100000, 100000))
end

local function getIntermediateSkyPosition()
    return Vector3.new(math.random(-100000, 100000), math.random(60000, 80000), math.random(-100000, 100000))
end

local function getExtremeSkyPosition()
    local function crazyRand()
        return math.random(-1000, 1000) * math.random(1000, 1000000)
    end
...
local function getUltimateUndergroundPosition()
    local x = randomLarge(-1e+26, 1e+26)
    local y = 4283947984
    local z = randomLarge(-1e+26, 1e+26)
    return Vector3.new(x, y, z)
end

local function getSilentSkyPosition()
    local x = randomLarge(-1e+24, 1e+24)
    local y = -1
    local z = randomLarge(-1e+24, 1e+24)
    return Vector3.new(x, y, z)
end
